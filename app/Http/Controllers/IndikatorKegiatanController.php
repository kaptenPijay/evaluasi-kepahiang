...
class IndikatorKegiatanController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            return DataTables::eloquent($data)
                ->filterColumn('indikator', function ($query, $keyword) {
                    $query->whereHas('indikatorKegiatan', function ($query) use ($keyword) {
                ...
                ->addColumn('indikator', function ($data) {
                    return $data->indikatorKegiatan->map(function ($item) {
        ...
        $title = auth()->user()->role == 'Super Admin' ? 'Indikator Kegiatan' : '';
        $updateUrl = 'indikatorKegiatan.update';
        $deleteUrl = 'indikatorKegiatan.destroy';
        ...
        return view('indikatorKegiatan.index', compact('request', 'title', 'updateUrl', 'deleteUrl', 'dataKegiatan', 'dataSatuans'));
    }
    public function store(Request $request)
    {
        ...
        $indikatorData = IndikatorKegiatan::create($validatedData);
        $realisasi = new RealisasiKegiatan([
    ...
    {
        $dataIndikator = IndikatorKegiatan::findOrFail($id);
        $validator = Validator::make($request->all(), [
            'kegiatan_id' => 'required',
            'indikator' => 'required',
            'satuan_id' => 'required',
