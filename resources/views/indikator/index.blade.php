...
@include('indikator.modal.delete')
...
<script type="text/javascript">
    ...
    function editData({indikator,id,target,tw_1,tw_2,tw_3,tw_4,program_id,satuan_id}) {
        $("#formEdit select[name='program_id']").val(program_id);
