...
<div class="container-fluid w-100 wrapperDataTableBackOffice regular-shadow data_table_satuan">
    ...
    <div class="wrapper_progress w-100">
        <a href="/back-office/indikator-kegiatan"
...
@include('indikatorKegiatan.modal.delete')
@include('indikatorKegiatan.modal.create')
@include('indikatorKegiatan.modal.edit')
@endsection
...
<script type="text/javascript">
    ...
    function loadData(){
        $('#serverSide').DataTable({
            ...
            ordering: false,
            ajax:{
                url: "{{ route('indikatorKegiatan.index') }}"
            },
            columns:[
                {
                    data: 'id',
    ...
    function editData({indikator,id,target,tw_1,tw_2,tw_3,tw_4,kegiatan_id,satuan_id}) {
