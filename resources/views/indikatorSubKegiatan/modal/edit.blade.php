<!-- Modal -->
<div class="modal fade modalForm modalDoubleCol" id="ModalEdit" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-md modal-dialog-centered" role="document"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="display: flex; flex-direction:column; justify-content:space-between">
                <form action="" method="POST" id="formEdit" style="display: flex; flex-direction: column; row-gap: 1em">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ old('anggaran') }}" name="anggaran" type="text" id="anggaran"
                            class="form-control {{ $errors->has('anggaran') ? 'border-danger' : 'border-none' }}"
                            placeholder="Masukkan anggaran" required onkeyup="formatRupiah(this)">
